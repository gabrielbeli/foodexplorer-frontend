  ...
  > h1 {
    ...
    @media (min-width: 769px) {
      ...
      > h1 {
        ...
        -webkit-animation: tracking-in-expand 0.7s cubic-bezier(0.215, 0.61, 0.355, 1) 0.65s both;
        animation: tracking-in-expand 0.7s cubic-bezier(0.215, 0.61, 0.355, 1) 0.65s both;
      }
    }
...
export const Form = styled.form`
  ...
  @media (min-width: 769px) {
    ...
    -webkit-animation: tilt-in-tr 0.65s cubic-bezier(0.25, 0.46, 0.45, 0.94) both;
  ...
  @keyframes jello-horizontal {
    ...
    30% {
      transform: scaled3d(1.25, 0.75, 1);
    }
    40% {
      transform: scaled3d(0.75, 1.25, 1);
    }
    50% {
      transform: scaled3d(1.15, 0.85, 1);
    }
    65% {
      transform: scaled3d(0.95, 1.05, 1);
    }
    75% {
      transform: scaled3d(1.05, 0.95, 1);
    }
    100% {
      transform: scaled3d(1, 1, 1);
    }
